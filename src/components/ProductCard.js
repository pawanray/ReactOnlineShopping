            ...
            <div className="mb-3 product-card text-center">
                <div className="card product-card-body">
                    ...
                    <div class="product-action">
                        <button class="btn btn-view" onClick={()=>handleClick(data,'View')}><AiOutlineSearch size='1.3rem'/></button>
                        <button class="btn btn-icon btn-add-cart" onClick={()=>handleClick(data,'AddToCart')}>ADD TO CART</button>
                        <button class="btn btn-fav" onClick={()=>handleClick(data,'Wishlist')}><AiOutlineHeart size='1.3rem'/></button>
                    </div>
                </div>
            </div>
        </div>
